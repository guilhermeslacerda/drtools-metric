...
public class StatisticalWmcOfTypeTest extends StatisticalOfTypeFixture {
	...
	public void testGetAverage() {
		assertEquals(1.0, st.getAverage(), 0.01);
	}
	...
	public void testGetFirstQuartile() {
		assertEquals(1.0, st.getFirstQuartile(), 0.01);
	}
	
	@Test
	public void testGetThirdQuartile() {
		assertEquals(1.0, st.getThirdQuartile(), 0.01);
	}
	
	@Test
	public void testGetMinValue() {
		assertEquals(1.0, st.getMinValue(), 0.01);
	}
	...
	public void testGetLowerFence() {
		assertEquals(1.0, st.getLowerFence(), 0.01);
	}
	
	@Test
	public void testGetUpperFence() {
		assertEquals(1.0, st.getUpperFence(), 0.01);
	}
